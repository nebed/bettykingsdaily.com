            ...
            <div class="col-full">
                ...
                <div class="featured">
                    ...
                    <div class="featured__column featured__column--big">
                        <div class="entry" style="background-image:url('{{ URL::asset('images/thumbs/featured/featured-guitarman.jpg') }}');">
                    ...
                    <div class="featured__column featured__column--small">
                        ...
                        <div class="entry" style="background-image:url('{{ URL::asset('images/thumbs/featured/featured-watch.jpg') }}');">
                        ...
                        <div class="entry" style="background-image:url('{{ URL::asset('images/thumbs/featured/featured-beetle.jpg') }}');">
        ...
        <div class="row masonry-wrap">
            <div class="masonry">
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__thumb">
                        <a href="single-standard.html" class="entry__thumb-link">
                            <img src="{{ URL::asset('images/thumbs/masonry/tulips-400.jpg') }}" 
                                    srcset="{{ URL::asset('images/thumbs/masonry/tulips-400.jpg') }} 1x, {{ URL::asset('images/thumbs/masonry/tulips-800.jpg') }} 2x" alt="">
                        </a>
                    </div>
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__thumb">
                        <a href="single-standard.html" class="entry__thumb-link">
                            <img src="{{ URL::asset('images/thumbs/masonry/cookies-400.jpg') }}" 
                                    srcset="{{ URL::asset('images/thumbs/masonry/cookies-400.jpg') }} 1x, {{ URL::asset('images/thumbs/masonry/cookies-800.jpg') }} 2x" alt="">
                        </a>
                    </div>
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__thumb">
                        <a href="single-standard.html" class="entry__thumb-link">
                            <img src="{{ URL::asset('images/thumbs/masonry/wheel-400.jpg') }}" 
                                    srcset="{{ URL::asset('images/thumbs/masonry/wheel-400.jpg') }} 1x, {{ URL::asset('images/thumbs/masonry/wheel-800.jpg') }} 2x" alt="">
                        </a>
                    </div>
                ...
                <article class="masonry__brick entry format-video" data-aos="fade-up">
                    ...
                    <div class="entry__thumb video-image">
                        <a href="https://player.vimeo.com/video/117310401?color=01aef0&title=0&byline=0&portrait=0" data-lity>
                            <img src="{{ URL::asset('images/thumbs/masonry/shutterbug-400.jpg') }}" 
                                    srcset="{{ URL::asset('images/thumbs/masonry/shutterbug-400.jpg') }} 1x, {{ URL::asset('images/thumbs/masonry/shutterbug-800.jpg') }} 2x" alt="">
                        </a>
                    </div>
